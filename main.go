...
func main() {
        ...
        rootCmd := &cobra.Command{
                ...
                Run: func(cmd *cobra.Command, args []string) {
                        ...
                        if showHelp || len(args) == 0 { // Corrected: Check for 0 args, not 1
                                _ = cmd.Usage()
                                return
                        }
        ...
        rootCmd.Flags().StringVarP(&interaction, "interaction", "a", "", "Sets what to do upon interacting with the toast")
